...
- [x] 7.1 An archived Routine's screen hides the add field
- [x] 7.2 An archived Routine's cards hide the delete icon
- [x] 7.3 An archived Routine's cards are not draggable / not wrapped in a reorderable list

## 8. Verify

- [x] 8.1 `flutter test` passes for all new and existing tests
- [x] 8.2 `flutter analyze` reports no new warnings
- [x] 8.3 Manually verify add (both suggestion-reuse and create-new paths), remove, and reorder in the running app via the `run` skill
