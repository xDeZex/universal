...
void main() {
  ...
  group('WorkoutRepository.load with Routines', () {
    test('load() populates routines alongside workouts and exercises', () async {
  ...
  group('WorkoutRepository.addRoutine', () {
    test(
      'with a unique name, creates and returns a new active Routine with no '
      'Planned Exercises',
      () async {
        final repository = WorkoutRepository(
          initialWorkouts: const [],
    ...
    test('with a blank name, returns null and leaves the Routine list unchanged', () {
      final repository = WorkoutRepository(
        initialWorkouts: const [],
        initialExercises: const [],
        initialRoutines: const [],
    ...
    test(
      'with a name colliding case-insensitively with an existing Routine, '
